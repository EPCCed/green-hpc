...
- Electricity is generated from various sources.
  ...
  - Other sources emit substantial quantities of carbon, e.g., fossil fuels.
    - The ratio of carbon emitted for coal:oil:gas is approximately 100:70:50.
...
- HPC applications are schedulable and reasonably portable (using containers).
...
- This requires the computation to be portable.
   ...
   - Incompatibilities can be resolved using containers, but check that containerisation overhead does not impact runtimes!
...
- Demand shaping is about scrutinising the resources required by your work.
  - Would your code use less energy if allowed to run for longer at reduced power?
  - Could you re-configure your code such that it is less expensive to run and still satisfy your research objectives?